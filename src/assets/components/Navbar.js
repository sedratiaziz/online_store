...
{/* CHANGE NAVBAR LANGUGE TO ENGLISH -- THIS IS REMINDER, DELETE IT WHEN FINISHED READING */}
        <div className={`collapse navbar-collapse ${isActive ? 'show' : ''}`} id="mainmenu">
          <ul id="uli" className="navbar-nav text-center ms-auto d-flex align-items-center">
            <li style={liStyle} className="nav-item px-4 pb-4 py-3 py-sm-4 py-md-2">
              ...
              <input type="text" placeholder={`${props.searchPlaceHolder}`} value={searchQuery} onChange={handleSearchChange} onKeyDown={handleSearch} className="searchBar mx-lg-5 mb-lg-1 " />
              </form>
            </li>
            <li style={liStyle} className="nav-item px-4 pt-4 py-3 py-sm-4 py-md-2">
              <Link to="/Offers" style={linkStyle}>{props.offers}</Link>
            </li>
            <li style={liStyle} className="nav-item px-4 pt-4 py-3 py-sm-4 py-md-2">
              <Link to="/ShoppingCart" style={linkStyle}>{props.shoppingCart}</Link>
            </li>
            <li style={liStyle} className="nav-item px-4 pb-4 py-3 py-sm-4 py-md-2">
              <Link to="/LogIn" style={linkStyle}>{props.logIn}</Link>
            </li>
            <li style={liStyle} className="nav-item px-4 pb-4 py-3 py-sm-4 py-md-2">
              <Link to="/Settings" style={linkStyle}>{props.settings}</Link>
            </li>
            {/* <li style={liStyle} className="nav-item px-4 pb-4 py-3 py-sm-4 py-md-2">
              <Link to="/Settings" style={linkStyle}>English</Link>
            </li> */}
          </ul>
        </div>
      </div>
