    ...
    <section id={`${props.id}`} className="py-5">
      <div className="container">
        ...
        <div className="row row-whith-wide-cards d-flex justify-content-center text-center py-0 py-md-2 py-lg-2">
          ...
          <div
            id="h10"
            className="col h1002 col-12 col-lg-4 col-md-6 col-sm-12 py-3"
          >
            <div className="card h-100 shadow" id="classic">
              <img
                alt="animg"
...
// old code if needed (with Link instead of Button at fvrt buttons ):
/*
add an alert when the favourite button is clicked and wreite in it "تمت إضافة المنتج إلى المفضلة!" import React from 'react';
import { Link } from 'react-router-dom';
...
export default CategWithoutBtn;
